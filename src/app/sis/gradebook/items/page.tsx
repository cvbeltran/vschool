...
export default function GradedItemsPage() {
  ...
  const handleContinue = () => {
    ...
    router.push(`/sis/gradebook/sections/${selectedSectionId}/items`);
  };
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold">Graded Items</h1>
          <p className="text-sm text-muted-foreground mt-1">
            Manage graded items for a section
          </p>
        </div>
      </div>
