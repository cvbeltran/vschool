...
/**
 * Teacher: My Observation Patterns
 * Shows observation patterns scoped to the current teacher
 */
export default async function MyObservationPatternsPage() {
  ...
  // Fetch insights (views are already scoped by RLS to teacher's data)
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-semibold">My Observation Patterns</h1>
          <p className="text-muted-foreground mt-1">
            Your observation patterns across competencies, indicators, and experiences
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>My Observations by Competency</CardTitle>
          <CardDescription>
            Count of your observations grouped by competency and domain
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle>My Observations by Experience</CardTitle>
          <CardDescription>
            Your observation frequency grouped by experience type
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle>My Indicator Occurrence</CardTitle>
          <CardDescription>
            How often each indicator appears in your observations
          </CardDescription>
        </CardHeader>
        <CardContent>
