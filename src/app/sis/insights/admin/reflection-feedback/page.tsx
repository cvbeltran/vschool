...
/**
 * Admin: Reflection & Feedback Insights
 * Shows reflection frequency, feedback volume, and alignment patterns
 */
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-semibold">Reflection & Feedback</h1>
          <p className="text-muted-foreground mt-1">
            Reflection frequency, feedback volume, and alignment patterns
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Reflection counts by teacher, school year, and quarter
          </CardDescription>
        </CardHeader>
        <CardContent>
          {reflectionFreq.length === 0 ? (
            <div className="text-center py-8 text-muted-foreground">
              ...
              <p className="text-sm mt-2">
                Teachers can complete reflections to track their practice.
              </p>
            </div>
          ) : (
              ...
              <table className="w-full border-collapse">
                ...
                <tbody>
                  {reflectionFreq.map((item, idx) => (
                    <tr key={`${item.teacher_id}-${item.school_year_id}-${item.quarter}-${idx}`} className="border-b hover:bg-muted/50">
        ...
        <CardContent>
          {alignment.length === 0 ? (
            <div className="text-center py-8 text-muted-foreground">
              ...
              <p className="text-sm mt-2">
                When teachers reflect and students provide feedback on the same experiences, alignment patterns emerge.
              </p>
            </div>
          ) : (
            <div className="overflow-x-auto">
